...
import time
import argparse
def Qwenvl_anno(testpath,example_path,res_path):
...
if __name__ == '__main__':
    # 创建参数解析器
    parser = argparse.ArgumentParser(description='Qwen-VL 讽刺检测')
    ...
    model = '/home/LLMs/Qwen2.5-VL-7B-Instruct'
    pipe = pipeline(model, backend_config=TurbomindEngineConfig(session_len=16384))
    # 调用主函数
    Qwenvl_anno(args.testpath, args.example_path, args.res_path)
