...
def process_files(input_dir, output_dir):
    ...
    # 获取所有JSON文件
    filelist = [file for file in os.listdir(input_dir) if  file.endswith('10_anno.json')]
...
def calculate_metrics(output_dir):
    ...
    """
    file_list = [file for file in os.listdir(output_dir) if file.endswith('10_anno.json')]
